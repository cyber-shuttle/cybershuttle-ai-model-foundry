...
This file lists the current maintainers of the Cybershuttle AI Model Foundry. For governance details, see [GOVERNANCE.md](GOVERNANCE.md).

[Core maintainers](#core-maintainers) · [Domain maintainers](#domain-maintainers) · [Emeritus](#emeritus)

---

## Core maintainers

Core maintainers have repository-wide merge access and are responsible for schema design, tooling, governance, and release management.
...
Former maintainers who have stepped down. Their contributions are gratefully recognized.
...
*To update this file, open a PR following the process in [GOVERNANCE.md](GOVERNANCE.md#becoming-a-maintainer).*
